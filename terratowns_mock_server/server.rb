...
# We are simulating having a state / database for the development server
# by setting a global variable. Never use a global variable
# in a produciton server.
$home = {}

# Below is a Ruby class that includes validations from ActiveRecord.
# This will represent the Home resources as a Ruby object.
class Home
  # Active model is part of Ruby on Rails.
  # It is used as an ORM. It has a model within
  # Active Model that provides validations.
  # The production Terratowns server is on Rails and uses
  # similar / identical validation.
  # https://guides.rubyonrails.org/active_model_basics.html
  # https://guides.rubyonrails.org/active_record_validations.html
  include ActiveModel::Validations

  # create some virtual attributes to be stored on this object
  # this will set a getter and a setter eg
  # home = new Home()
